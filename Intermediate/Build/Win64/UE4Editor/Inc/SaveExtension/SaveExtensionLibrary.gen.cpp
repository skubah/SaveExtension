...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USaveExtensionLibrary_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USaveExtensionLibrary_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USaveExtensionLibrary()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USaveExtensionLibrary_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USaveExtensionLibrary, 1120301611);
	template<> SAVEEXTENSION_API UClass* StaticClass<USaveExtensionLibrary>()
	{
		return USaveExtensionLibrary::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USaveExtensionLibrary(Z_Construct_UClass_USaveExtensionLibrary, &USaveExtensionLibrary::StaticClass, TEXT("/Script/SaveExtension"), TEXT("USaveExtensionLibrary"), false, nullptr, nullptr, nullptr);
